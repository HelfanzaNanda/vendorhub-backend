...
export class IndustryClassification extends AuditBaseEntity {
    ...
    @ManyToMany(() => CompetencyItem, competencyItem => competencyItem.industryClassifications)
    @JoinTable({
        name: 'industry_class_has_competency_items',
        joinColumn: { name: 'industry_classification_id', referencedColumnName: 'id' },
        inverseJoinColumn: { name: 'competency_item_id', referencedColumnName: 'id' },
    })
