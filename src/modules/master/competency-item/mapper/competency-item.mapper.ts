...
export class CompetencyItemMapper {
    static toResponse(entity: CompetencyItem): CompetencyItemResponseDto {
        return {
            ...
            competencySubCategory: entity.competencySubCategory ? { id: entity.competencySubCategory.id, name: entity.competencySubCategory.name } : null,
            audit: {
    ...
    static toResponses(entities: CompetencyItem[]): CompetencyItemResponseDto[] {
