...
export async function seedVendorStatus(dataSource: DataSource) {
    const arr = [
        ...
        },
        {
            ...
            description:
                'Status pada saat vendor melakukan perubahan data perusahaan',
        },
        {
        ...
        },
        {
            ...
            name: 'Passive',
            description:
                'Vendor yang tidak merubah datanya pada waktu tertentu setelah pemuktahiran data',
        },
        {
            code: 'REVISION_REGISTRATION',
            name: 'Revision Registration',
            description:
                'Pending calon vendor dimana admin operasional mengirim notifikasi ke vendor untuk merevisi data perusahaannya (Status vendor yang belum pernah aktif)',
        },
        {
            code: 'REQUEST_FOR_UPDATE',
            name: 'Request For Update',
            description:
                'Status vendor disaat pemuktahiran data , permintaan untuk segera merubah data perusahaannya',
        },
        {
            code: 'REVISION',
            name: 'Revision',
            description:
                'Status vendor yang harus merevisi datanya setelah merubah data perusahaan (vendor yang sudah pernah aktif',
        },
        {
            code: 'RE_ACTIVATION',
            name: 'Re-Activation',
            description:
                'Vendor yang tidak merubah datanya pada waktu tertentu yang dalam status passive',
        },
    ];
